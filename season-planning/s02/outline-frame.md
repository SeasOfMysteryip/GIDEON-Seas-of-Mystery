---
id: planning.s02.outline_frame
type: season_outline
status: working
source_module: "00_Canon Bible Core v2"
source_section: "Season 2 - The Flood & The Flame"
...
# Season Two Outline Frame

## Status

This file is planning scaffolding extracted from `00`. It is useful for future development, but it is not final canon law.
...
- confirm how the Gull returns to the Spectral Sea
...
- launch the relic-circuit treasure arc
...
- formalize Watchers and Protectors in-story
...
- Blackbeard's coronation path
- Atlantis gained at terrible cost
- the crew transformed by the season
- Sophia's fate hardened or split

## Development Note

This file still contains planning questions in the source material. Treat it as an outline frame, not a locked season bible.
